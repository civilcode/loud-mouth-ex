defmodule LoudMouthBackoffice.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import LoudMouthBackoffice.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&LoudMouthBackoffice.ErrorHelpers.translate_error/1)
